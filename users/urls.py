...
from users.views import EmployeeCreateView, EmployeeMainMenu, EmployeeListView, EmployeeDetailView, CurrentEmployeeDetailView
...
urlpatterns = [
	...
	path("account/profile/", CurrentEmployeeDetailView.as_view(), name="current_employee_detail"),
