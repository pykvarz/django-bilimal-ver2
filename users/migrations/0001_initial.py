    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surname', models.CharField(blank=True, max_length=50, verbose_name='Отчетсво')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year_of_admission', models.DateField(blank=True, null=True, verbose_name='Год поступления')),
                ('year_of_ending', models.DateField(blank=True, null=True, verbose_name='Год окончания')),
                ('speciality', models.CharField(blank=True, max_length=500, null=True, verbose_name='Специальность')),
                ('type_education', models.CharField(blank=True, max_length=500, null=True, verbose_name='Образование')),
